...
export default class TorAndKnotAndConeGroup extends ElementGroup {
  constructor() {
    super();
  ...
  _setElement() {
    ...
    if (this._debug.Active) {
      const debugFolder = this._debug.UI.addFolder('TorAndKnotAndConeGroup');
  ...
  _setItems() {
    ...
    const cone = new Cone();
    this.Items.push(cone);
    this.Instance.add(cone.Instance);
